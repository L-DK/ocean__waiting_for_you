...
public class k_createFood : MonoBehaviour
{
    //此脚本用来创建食物

    public GameObject createFood;//设置创建对象
    public GameObject cteate_Parent;//创建父级

    private void Start()
    {
        InvokeRepeating("create", 0f, 0.5f);
    ...
    void create()
    {
        ...
        GameObject new_Obj = Instantiate(createFood);  //克隆个体
